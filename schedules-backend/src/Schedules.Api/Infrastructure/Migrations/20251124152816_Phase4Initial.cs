    ...
    public partial class Phase4Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "recurrences",
                columns: new[] { "recurrence_id", "by_day", "by_month_day", "created_at", "interval", "pattern", "until" },
                values: new object[] { new Guid("aaaaaaaa-bbbb-cccc-dddd-444444444444"), "MO,WE,FR", null, new DateTimeOffset(new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), 1, "WEEKLY", null });

            migrationBuilder.InsertData(
                table: "schedules",
                columns: new[] { "schedule_id", "calendar_event_id", "created_at", "created_by", "description", "end_time", "is_all_day", "RecurrenceId", "source", "start_time", "status", "team_id", "title", "updated_at", "user_id" },
                values: new object[] { new Guid("aaaaaaaa-bbbb-cccc-dddd-111111111111"), null, new DateTimeOffset(new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), 1L, "Seeded schedule for QA validation", new DateTimeOffset(new DateTime(2025, 1, 6, 17, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), false, new Guid("aaaaaaaa-bbbb-cccc-dddd-444444444444"), "Internal", new DateTimeOffset(new DateTime(2025, 1, 6, 9, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), "Confirmed", 10L, "Sample Onsite Shift", new DateTimeOffset(new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), 1L });

            migrationBuilder.InsertData(
                table: "tasks",
                columns: new[] { "task_id", "assignee_id", "created_at", "created_by", "description", "due_date", "ms_graph_item_id", "priority", "schedule_id", "status", "tags", "title", "updated_at" },
                values: new object[] { new Guid("aaaaaaaa-bbbb-cccc-dddd-222222222222"), 1L, new DateTimeOffset(new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), 2L, "Initial seeded task for smoke testing", new DateTimeOffset(new DateTime(2025, 1, 7, 17, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), null, "High", new Guid("aaaaaaaa-bbbb-cccc-dddd-111111111111"), "InProgress", new[] { "seed", "demo" }, "Seed Task", new DateTimeOffset(new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) });

            migrationBuilder.InsertData(
                table: "task_notes",
                columns: new[] { "note_id", "author_id", "body", "created_at", "task_id", "updated_at" },
                values: new object[] { new Guid("aaaaaaaa-bbbb-cccc-dddd-333333333333"), 2L, "Seeded comment for validation.", new DateTimeOffset(new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)), new Guid("aaaaaaaa-bbbb-cccc-dddd-222222222222"), new DateTimeOffset(new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)) });
