...
//        "appium:noReset": true,
//        'appium:dartObservatoryUri': 'ws://127.0.0.1:65279/yn8sa1NNi08=/ws',
...
exports.config = {
    ...
    capabilities: [{
    platformName: 'Android',
    // If you want to override via env: set APPIUM_DEVICE, APPIUM_APP, APPIUM_PLATFORM_VERSION, DART_OBS_URI
    'appium:deviceName': process.env.APPIUM_DEVICE || 'emulator-5554',
    'appium:app': process.env.APPIUM_APP || 'C:/Users/SathijaDeshapriya/Downloads/IT Center Project 2/mobile-app/build/app/outputs/flutter-apk/app-debug.apk',
