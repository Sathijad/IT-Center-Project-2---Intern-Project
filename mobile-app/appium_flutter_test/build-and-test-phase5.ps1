# Build and Test Script for Phase 5 Appium Tests (Events & Announcements)
# This script builds the Flutter app with Flutter Driver enabled and runs Appium tests
# Usage: .\build-and-test-phase5.ps1 [test-file] [-SkipBuild]
# Examples:
#   .\build-and-test-phase5.ps1 phase5_announcements_overview.spec.js
#   .\build-and-test-phase5.ps1 phase5_announcements_overview.spec.js -SkipBuild
...
Write-Host "Phase 5: Appium Test Build & Run (Events & Announcements)" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
if ($TestFile -eq "") {
    ...
    Write-Host "   - phase5_announcements_overview.spec.js" -ForegroundColor Gray
    Write-Host ""
    Write-Host "Usage: .\build-and-test-phase5.ps1 [test-file] [-SkipBuild]" -ForegroundColor Yellow
    Write-Host "Examples:" -ForegroundColor Yellow
    Write-Host "   .\build-and-test-phase5.ps1 phase5_announcements_overview.spec.js" -ForegroundColor Gray
    Write-Host "   .\build-and-test-phase5.ps1 phase5_announcements_overview.spec.js -SkipBuild" -ForegroundColor Gray
    Write-Host ""
    exit 1
}
...
if (-not (Test-Path $testFilePath)) {
    ...
    Get-ChildItem "test\specs\phase5*.spec.js" | ForEach-Object {
