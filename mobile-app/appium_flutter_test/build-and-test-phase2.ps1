# Build and Test Script for Phase 2 Appium Tests (Staff Leave & Attendance Management)
# This script builds the Flutter app with Flutter Driver enabled and runs Appium tests
# Usage: .\build-and-test-phase2.ps1 [test-file] [-SkipBuild]
# Examples:
#   .\build-and-test-phase2.ps1 phase2_complete_leave_attendance_flow.spec.js
#   .\build-and-test-phase2.ps1 phase2_complete_leave_attendance_flow.spec.js -SkipBuild
...
Write-Host "Phase 2: Appium Test Build & Run (Staff Leave & Attendance Management)" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
if ($TestFile -eq "") {
    ...
    Write-Host "   - phase2_complete_leave_attendance_flow.spec.js" -ForegroundColor Gray
    Write-Host ""
    Write-Host "Usage: .\build-and-test-phase2.ps1 [test-file] [-SkipBuild]" -ForegroundColor Yellow
    Write-Host "Examples:" -ForegroundColor Yellow
    Write-Host "   .\build-and-test-phase2.ps1 phase2_complete_leave_attendance_flow.spec.js" -ForegroundColor Gray
    Write-Host "   .\build-and-test-phase2.ps1 phase2_complete_leave_attendance_flow.spec.js -SkipBuild" -ForegroundColor Gray
    Write-Host ""
    exit 1
}
...
if (-not (Test-Path $testFilePath)) {
    ...
    Get-ChildItem "test\specs\phase2*.spec.js" | ForEach-Object {
