# Build and Test Script for Phase 1 Appium Tests (Staff Authentication & Role Management)
# This script builds the Flutter app with Flutter Driver enabled and runs Appium tests
# Usage: .\build-and-test-phase1.ps1 [test-file] [-SkipBuild]
# Examples:
#   .\build-and-test-phase1.ps1 phase1_complete_auth_role_flow.spec.js
#   .\build-and-test-phase1.ps1 phase1_complete_auth_role_flow.spec.js -SkipBuild
...
Write-Host "Phase 1: Appium Test Build & Run (Staff Authentication & Role Management)" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
if ($TestFile -eq "") {
    ...
    Write-Host "   - phase1_complete_auth_role_flow.spec.js" -ForegroundColor Gray
    Write-Host ""
    Write-Host "Usage: .\build-and-test-phase1.ps1 [test-file] [-SkipBuild]" -ForegroundColor Yellow
    Write-Host "Examples:" -ForegroundColor Yellow
    Write-Host "   .\build-and-test-phase1.ps1 phase1_complete_auth_role_flow.spec.js" -ForegroundColor Gray
    Write-Host "   .\build-and-test-phase1.ps1 phase1_complete_auth_role_flow.spec.js -SkipBuild" -ForegroundColor Gray
    Write-Host ""
    exit 1
}
...
if (-not (Test-Path $testFilePath)) {
    ...
    Get-ChildItem "test\specs\phase1*.spec.js" | ForEach-Object {
