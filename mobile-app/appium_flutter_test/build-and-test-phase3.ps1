# Build and Test Script for Phase 3 Appium Tests (Staff Room & Resource Booking)
# This script builds the Flutter app with Flutter Driver enabled and runs Appium tests
# Usage: .\build-and-test-phase3.ps1 [test-file] [-SkipBuild]
# Examples:
#   .\build-and-test-phase3.ps1 phase3_complete_booking_flow.spec.js
#   .\build-and-test-phase3.ps1 phase3_complete_booking_flow.spec.js -SkipBuild
...
Write-Host "Phase 3: Appium Test Build & Run (Staff Room & Resource Booking)" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
if ($TestFile -eq "") {
    ...
    Write-Host "   - phase3_complete_booking_flow.spec.js" -ForegroundColor Gray
    Write-Host ""
    Write-Host "Usage: .\build-and-test-phase3.ps1 [test-file] [-SkipBuild]" -ForegroundColor Yellow
    Write-Host "Examples:" -ForegroundColor Yellow
    Write-Host "   .\build-and-test-phase3.ps1 phase3_complete_booking_flow.spec.js" -ForegroundColor Gray
    Write-Host "   .\build-and-test-phase3.ps1 phase3_complete_booking_flow.spec.js -SkipBuild" -ForegroundColor Gray
    Write-Host ""
    exit 1
}
...
if (-not (Test-Path $testFilePath)) {
    ...
    Get-ChildItem "test\specs\phase3*.spec.js" | ForEach-Object {
